...
处理全部 `scene = "问账户"` 的记录；忽略其他场景记录。仅使用输入中明确提供的信息，不编造上下文或实体。
...
| --- | --- | --- | --- |
| 资产总览 | `account_overview` | ACC-01～ACC-10 | 总资产；基金、投顾、货币、专户账户及持有详情；投顾组合和调仓记录 |
| 持仓结构 | `holding_structure` | ACC-11～ACC-12 | 全账户持仓明细、资产分布、集中度 |
| 收益表现 | `return_performance` | ACC-13～ACC-14 | 全账户收益结果、区间收益、收益日历、基准比较 |
| 收益归因 | `return_attribution` | ACC-15～ACC-17 | 收益原因、收益来源构成、区间归因、买入位置、回撤 |
