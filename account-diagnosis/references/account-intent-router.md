...
| 收益归因 | `return_attribution` | ACC-15 | 查看产品、类型或行业维度的收益贡献和拖累 |
...
- “我赚了多少 / 今年收益怎么样 / 跑赢大盘了吗”
- “去年或历年收益 / 按日、按月、按年看收益明细 / 哪段时间赚亏”
...
- **当前年度总览 vs 历史分年 vs 收益日历**：“今年收益怎么样”进入 `return_performance` 后选择 ACC-13-A；去年、历年或跨年度视角选择 ACC-13-B；要求按日、按月、按年展开明细或收益日历选择 ACC-14。
- **持有基金 vs 自选基金**：账户中实际持有的基金问题按前述账户意图判断；自选、关注、估值、净值更新和当日涨跌进入 `watchlist_valuation`。
- **数据能力不改变意图和选卡**：无论卡片是否已有接口记录或数据，始终按用户语义识别正确意图，由业务模块输出目标 deferred 卡片。
